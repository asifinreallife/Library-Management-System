...
namespace csharpproject {
    ...
    public partial class project1DataSet12 : global::System.Data.DataSet {
        ...
        public partial class BOOKDataTable : global::System.Data.TypedTableBase<BOOKRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BOOKRow AddBOOKRow(int Book_ID, string Book_Name, double Book_Price, string Availability, string Language, string Publish_Year, string Genre_Name, string Author_Name, string Publisher_Name, string Publisher_Address) {
            ...
            private void InitClass() {
                ...
                this.columnPublish_Year = new global::System.Data.DataColumn("Publish_Year", typeof(string), null, global::System.Data.MappingType.Element);
                ...
                this.columnPublish_Year.MaxLength = 2147483647;
        ...
        public partial class BOOKRow : global::System.Data.DataRow {
            ...
            public string Publish_Year {
                get {
                    return ((string)(this[this.tableBOOK.Publish_YearColumn]));
                }
                set {
...
namespace csharpproject.project1DataSet12TableAdapters {
    ...
    public partial class BOOKTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[BOOK] WHERE (([Book_ID] = @Original_Book_ID) AND ([Book_Price]" +
                " = @Original_Book_Price) AND ([Availability] = @Original_Availability))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[BOOK] SET [Book_ID] = @Book_ID, [Book_Name] = @Book_Name, [Book_Price] = @Book_Price, [Availability] = @Availability, [Language] = @Language, [Publish_Year] = @Publish_Year, [Genre_Name] = @Genre_Name, [Author_Name] = @Author_Name, [Publisher_Name] = @Publisher_Name, [Publisher_Address] = @Publisher_Address WHERE (([Book_ID] = @Original_Book_ID) AND ([Book_Price] = @Original_Book_Price) AND ([Availability] = @Original_Availability));
SELECT Book_ID, Book_Name, Book_Price, Availability, Language, Publish_Year, Genre_Name, Author_Name, Publisher_Name, Publisher_Address FROM BOOK WHERE (Book_ID = @Book_ID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Publish_Year", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Publish_Year", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Fill(project1DataSet12.BOOKDataTable dataTable) {
        ...
        public virtual project1DataSet12.BOOKDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            project1DataSet12.BOOKDataTable dataTable = new project1DataSet12.BOOKDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(project1DataSet12.BOOKDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Book_ID, double Original_Book_Price, string Original_Availability) {
        ...
        public virtual int Update(int Book_ID, string Book_Name, double Book_Price, string Availability, string Language, string Publish_Year, string Genre_Name, string Author_Name, string Publisher_Name, string Publisher_Address, int Original_Book_ID, double Original_Book_Price, string Original_Availability) {
            ...
            if ((Publish_Year == null)) {
                throw new global::System.ArgumentNullException("Publish_Year");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Publish_Year));
            }
            if ((Genre_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Book_Name, double Book_Price, string Availability, string Language, string Publish_Year, string Genre_Name, string Author_Name, string Publisher_Name, string Publisher_Address, int Original_Book_ID, double Original_Book_Price, string Original_Availability) {
            return this.Update(Original_Book_ID, Book_Name, Book_Price, Availability, Language, Publish_Year, Genre_Name, Author_Name, Publisher_Name, Publisher_Address, Original_Book_ID, Original_Book_Price, Original_Availability);
        }
    }
